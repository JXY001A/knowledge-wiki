...
// 蓝色系色板
const COLORS = ['#4d6bfe', '#16a34a', '#eab308', '#ef4444', '#8b5cf6', '#f97316', '#06b6d4', '#ec4899'];
  ...
  return (
    <ResponsiveContainer width="100%" height={200}>
      <LineChart data={data}>
        ...
        {lines.some(l => l.yAxisId) && <YAxis yAxisId="y1" orientation="right" tick={{ fontSize: 10 }} stroke="#9ca3af" />}
        <Tooltip />
        {lines.map(l => (
