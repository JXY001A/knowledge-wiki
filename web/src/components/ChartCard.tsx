...
// 与新主题协调的图表色板
const COLORS = ['#4b5cc4', '#16a34a', '#eab308', '#ef4444', '#8b5cf6', '#f97316', '#06b6d4', '#ec4899'];
  ...
  return (
    <ResponsiveContainer width="100%" height={200}>
      <LineChart data={data}>
        ...
        <XAxis dataKey="date" tick={{ fontSize: 10 }} stroke="#b8b5ae" />
        <YAxis tick={{ fontSize: 10 }} stroke="#b8b5ae" />
        {lines.some(l => l.yAxisId) && <YAxis yAxisId="y1" orientation="right" tick={{ fontSize: 10 }} stroke="#b8b5ae" />}
        <Tooltip />
        {lines.map(l => (
