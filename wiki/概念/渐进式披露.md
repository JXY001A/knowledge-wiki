...
sources:
  - "[[资料摘要：Agent 知识管理与自进化]]"
  - "[[资料摘要：Agent技术范式演变]]"
related_concepts: ["知识工程（Knowledge Engineering）", "Agent Skills体系", "上下文工程"]
confidence: high
---
...
在 Agent 系统中，渐进式披露指将 System Prompt 固化为稳定底座，将动态的任务要求、领域知识和 Skill 文件存储在外部文件系统中，Agent 根据任务意图按需加载对应文件。
...
| 上下文工程 | 上下文工程是整体架构方法论，渐进式披露是其核心加载机制 |
