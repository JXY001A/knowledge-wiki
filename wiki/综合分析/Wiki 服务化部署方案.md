...
8. 注册企业微信，配置 Bot 回调 URL → `http://8.133.175.201:9400/webhook`（需手动获取 Credentials）
9. 配置 Mac 本地 Claude Code → MCP Client → `8.133.175.201:9300`（在 `.mcp.json` 或 `claude settings` 中注册）
